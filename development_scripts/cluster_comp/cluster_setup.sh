...
# sbatch --ntasks=1 --cpus-per-task=20 --time=4:00:00 --mem-per-cpu=1024 Rscript development_scripts/cluster_comp/cluster_setup.sh
Rscript /cluster/home/merler/USE.MCMC/development_scripts/cluster_comp/distributed_precomputation.R --seed 42
