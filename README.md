...
<figure>
<img src="man/figures/plot-pipeline-scheme-1.png"
alt="scheme of the proposed method" />
<figcaption aria-hidden="true">scheme of the proposed
method</figcaption>
</figure>

# This is a development repository

It forks the [USE package](https://github.com/danddr/USE) with the goal
to extend it to enable MCMC sampling in higher dimensional spaces. The
repo can be downloaded by using the following command in a terminal or
...
<figure>
<img src="man/figures/plot-in-geo-1.png"
alt="Sampled points in the geographical space" />
<figcaption aria-hidden="true">Sampled points in the geographical
space</figcaption>
</figure>
...
<figure>
<img src="man/figures/compare2dvs3d.png"
alt="posterior density of the first three principal components" />
<figcaption aria-hidden="true">posterior density of the first three
principal components</figcaption>
</figure>

## Sampling engines

`mcmcSampling()` and `paSamplingMcmc()` accept an `engine` argument of
