...
The four density figures introduced in this section (the naive environmental density, the environmental threshold sweep, the species-quantile sweep with contours, and the full pseudo-absence density) together describe how the sampling function is built up step by step. The following compound figure assembles them at a glance.
...
methods.overview <- cowplot::plot_grid(
  ...
  overview.badge(strip.title(p.density.pseudo.absence), "d", "Pseudo-absence density"),
  ncol  = 2,
  align = "hv",
  axis  = "tblr"
)
