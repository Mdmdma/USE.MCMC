...
```
```{r show-gif-example-chain, echo=FALSE}
...
```{r show-gif-gaussian, echo=FALSE}
...
```
```{r show-gif-gaussian-long, echo=FALSE}
...
```
```{r show-gif-naive-density, echo=FALSE}
...
```
```{r show-gif-ps-density, echo=FALSE}
