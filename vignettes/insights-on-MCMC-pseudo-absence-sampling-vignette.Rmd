...
sampled.points <- mcmcSampling(dataset=starting.point,
                               dimensions = c("x", "y"),
...
gif.example.chain <- animate(a.example.chain, renderer = gifski_renderer(), width = 700, height = 600, fps = 10, duration = 4)
