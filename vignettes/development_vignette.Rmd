...
```
In difference to the approaches on which the MCMC approach is based it works in higher dimension.
...
```
The interpret ability of the results now gets more complicated. The expected distribution of uniform sampling of one variable is dependent on the range of the other dimensions at diffenent values. 
